...
var graphik400 = new FontFaceObserver("Graphik", {
	weight: 400
});
var graphik500 = new FontFaceObserver("Graphik", {
	weight: 500
});
var graphik600 = new FontFaceObserver("Graphik", {
	weight: 600
});

Promise.all([
	graphik400.load(null, 7000),
	graphik500.load(null, 7000),
	graphik600.load(null, 7000)
]).then(function() {
	document.body.classList.add('page_fonts_loaded');
}, function() {
	document.body.classList.add('page_fonts_timeout');
});
